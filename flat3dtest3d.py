...
def makescene(t):
	camera = f3d.Camera3d(position=(0,0,0), direction=(0,1,0), up=(0,0,1), fov=xf.rad(90), aspect=W/H, near=1e-10)
	...
	scene.addElem(f3d.Triangle3d(points=[(-1,2,1), (0,-0.0001,-1), (1,1,0.5)], fill=(1,0,0)))
