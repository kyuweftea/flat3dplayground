...
def makescene(t):
	camera = f3d.Camera3d(position=(0,0,0), direction=(0,1,0), up=(0,0,1), fov=xf.rad(90), aspect=1, near=1e-10)
	...
	# scene.addElem(f3d.Triangle3d(points=[(-1,0.25,0), (1,0.25,0), (0,0.25,1)], fill=(0,1,1)))
	# scene.addElem(f3d.Triangle3d(points=[(-1,0.5,-0.5), (1,0.5,0), (0,0.5,1)], fill=(1,1,0)))
